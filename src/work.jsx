...
function Trainings (){
                ...
                <div class="container px-6 py-10 mx-auto">
                    <div class="lg:flex lg:items-center">
                        <div class="w-full space-y-12 lg:w-1/2 ">
                            <div>
                                <a href="#" class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">explore our <br></br> awesome Trainings!</a>
                            
                            <div class="mt-2">
                                <span class="inline-block w-40 h-1 bg-black rounded-full"></span>
                                <span class="inline-block w-3 h-1 ml-1 bg-black rounded-full"></span>
                                <span class="inline-block w-1 h-1 ml-1 bg-black rounded-full"></span>
                            </div>
                            <div id="checkBox"> 
    ...
    <span class="inline-block p-2 text-blue-500 bg-blue-100 rounded-xl md:mx-4 dark:text-white dark:bg-blue-500">
        ...
        <div class="mt-4 md:mx-4 md:mt-0">
            <a href="#" class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Intro to CRMs</a>
    ...
    <div class="md:flex md:items-start md:-mx-4">
        ...
        <div class="mt-4 md:mx-4 md:mt-0">
                <a href="#" class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Intro to Software Design</a>
        ...
        <div class="md:flex md:items-start md:-mx-4">
            ...
            <div class="mt-4 md:mx-4 md:mt-0">
                <a href="#" class="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Entrepreneurship 101</a>
